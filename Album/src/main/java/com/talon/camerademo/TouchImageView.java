...
public class TouchImageView extends ImageView {
    ...
    private void fixTrans() {
        ...
        float fixTransX = getFixTrans(transX, viewWidth, getImageWidth(), true);
        float fixTransY = getFixTrans(transY, viewHeight, getImageHeight(), false);
    ...
    protected FlingRunnable createFlingRunnable(float velocityX, float velocityY) {
        return new Fling((int) velocityX, (int) velocityY);
    }
    ...
    private class GestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY)
        {
            ...
            fling = createFlingRunnable(velocityX, velocityY);
     ...
     *
     */
    private class Fling implements FlingRunnable {
    ...
    protected interface FlingRunnable extends Runnable {
        public void cancelFling();
    }
